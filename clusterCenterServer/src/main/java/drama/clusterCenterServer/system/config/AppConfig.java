package drama.clusterCenterServer.system.config;
...
public class AppConfig {
    ...
    public static class Key {
        ...
        public static final String WS_Common_Config_use_net_ip_first = "DM-Common-Config.use-net-ip-first";
    }
    ...
    public static void init() {
        try {
            ...
            LOGGER.error("AppConfig 初始化异常！", e);
        }
    }
