...
public class LoadAllRoomPlayerExtensions {
    ...
    private static void _addExtension(RoomPlayerCtrl roomPlayerCtrl, Class<? extends RoomPlayerExtension> clzz) throws Exception {
        RoomPlayerExtension<?> extension = clzz.getConstructor(RoomPlayerCtrl.class).newInstance(roomPlayerCtrl);
